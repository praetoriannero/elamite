...
Status: **complete and stable**. `std.ast` 1.0 is frozen, the bounded
interpreter drives deterministic expansion, and the former experimental gate
has been removed.
